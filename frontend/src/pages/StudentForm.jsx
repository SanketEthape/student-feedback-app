      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: "var(--muted)", fontSize: 14 }}>
            {form.faculty?.name} · {form.faculty?.department} · {form.subject}
          </p>
        </div>
        ...
        {step === "info" && (
          <div className="card">
            ...
            >
              Your name and roll number are optional. This helps your faculty
              track progress.
            </p>
            <div style={{ marginBottom: 14 }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setInfo({ ...info, studentName: e.target.value })
                }
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <input
                value={info.rollNo}
                onChange={(e) => setInfo({ ...info, rollNo: e.target.value })}
            ...
            <div style={{ display: "grid", gap: 16 }}>
              {form.questions.map((q, i) => (
                <div key={q._id} className="card">
                  ...
                  <p
                    style={{ marginBottom: 14, fontSize: 15, lineHeight: 1.6 }}
                  >
                    {q.question}
                  </p>
        ...
        {step === "done" && (
          <div className="card" style={{ textAlign: "center" }}>
            ...
            <p
              style={{
                color: "var(--muted)",
                marginBottom: recommendation ? 28 : 0,
                fontSize: 14,
              }}
            >
            ...
            {recommendation && (
              ...
              >
                <h3 style={{ marginBottom: 10, fontSize: 17 }}>
                  💡 Your Personalized Study Recommendation
                </h3>
                <p
                  style={{
                    fontSize: 14,
